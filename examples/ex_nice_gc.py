...
adc.STRT = 26 #start pin - output from pi to ADC
adc.PWDN  = 27 #power down - output from pi to ADC
adc.DRDY  = 12 #data ready - input from ADC to pi
...
adc.init_GPIO_SPI() #sets up spi and gpio communication on Raspberry Pi
adc.restart() #restarts the ADC
